...
class Loading extends Scene {
  preload() {
    ...
    this.load.image("egg1", "assets/sprites/Egg/Egg_1.png");
    this.load.image("egg2", "assets/sprites/Egg/Egg_2.png");
    this.load.image("egg3", "assets/sprites/Egg/Egg_3.png");
    this.load.image("egg4", "assets/sprites/Egg/Egg_4.png");
    this.load.image("egg5", "assets/sprites/Egg/Egg_5.png");
    this.load.image("egg6", "assets/sprites/Egg/Egg_6.png");
    this.load.image("egg7", "assets/sprites/Egg/Egg_7.png");
    this.load.image("egg8", "assets/sprites/Egg/Egg_8.png");
    this.load.image("egg9", "assets/sprites/Egg/Egg_9.png");
    this.load.image(
      "egg10",
      "assets/sprites/Egg/Egg_10.png"
    );
